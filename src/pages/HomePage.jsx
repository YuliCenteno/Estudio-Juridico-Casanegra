  ...
  return (
    <>
      ...
      <main>
        ...
        {/* =====================================================
            NOVEDADES / PUBLICACIÓN JURÍDICA
            ===================================================== */}
          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <div className="text-center mb-12">
                ...
                <span className="inline-block py-1.5 px-5 rounded-full bg-secondary/20 text-primary font-medium text-xs md:text-sm tracking-[0.2em] uppercase mb-5 border border-border/60">
                  Novedades
                </span>
                ...
                <p className="text-muted-foreground font-light">
                  Conocé la reciente publicación de nuestro estudio.
                </p>
              ...
              <div className="bg-card border border-border/60 rounded-2xl p-8 md:p-10 shadow-sm">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                  ...
                  <div className="max-w-2xl">
                    ...
                    <p className="text-sm uppercase tracking-widest text-primary/70 mb-3">
                      Artículo jurídico
                    </p>
                    ...
                    <p className="text-muted-foreground leading-relaxed font-light mb-6">
                      Artículo elaborado por Francisco Casanegra sobre una temática de interés jurídico.
                    </p>

                    <p className="text-sm text-muted-foreground">
                      Por <strong>Francisco Casanegra</strong>
                    </p>
                  ...
                  <div className="shrink-0">
                    ...
                    <a
                      href="PEGAR-AQUÍ-EL-LINK-DEL-PDF"
                      target="_blank"
